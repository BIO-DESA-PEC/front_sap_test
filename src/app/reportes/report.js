...
const fetchItems = async () => {
  try {
    const response = await axios.get("https://sap-back-test.onrender.com/items");
...
const fetchBodegas = async () => {
  try {
    const response = await axios.get("https://sap-back-test.onrender.com/get-warehouses");
  ...
  const obtenerReportes = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get(`https://sap-back-test.onrender.com/reportinventario`, {
        params: {
